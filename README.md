...
This command line interpreter  serves as the frontend of the web app where users can interact with the backend which was developed with python Object Oriented programming.
...
```
git clone https://github.com/Lanrewest/AirBnB_clone.git
```
